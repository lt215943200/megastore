...
import com.mega.test.constants.MegaTestConstants;
import com.mega.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MegaTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/megatest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/megatest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/megatest/import/cstickets.impex");
			...
			importImpexFile(context, "/megatest/import/csquotes.impex");
		}
	}
}
