 ...
 */
package com.mega.cockpits.setup;
...
import com.mega.cockpits.constants.MegaCockpitsConstants;
 ...
 */
@SystemSetup(extension = MegaCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MegaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MegaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MegaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/megacockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
