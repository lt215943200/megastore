 ...
 */
package com.mega.core.constants;

/**
 * Global class for all MegaCore constants. You can add global constants for your extension into this class.
 */
public final class MegaCoreConstants extends GeneratedMegaCoreConstants
{
	public static final String EXTENSIONNAME = "megacore";


	private MegaCoreConstants()
	{
		//empty
	}
