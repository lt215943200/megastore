 ...
 */
package com.mega.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MegaFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MegaFulfilmentProcessConstants.PARENT_PROCESS);
