...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/megastorefront/electronics/en",
						"https://electronics.local:9002/megastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/megastorefront/electronics/en",
						"https://electronics.local:9002/megastorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/megastorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/megastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/megastorefront/electronics/en",
						"https://electronics.local:9002/megastorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/megastorefront",
						"https://electronics.local:9002/megastorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/megastorefront",
						"https://electronics.local:9002/megastorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/megastorefront/electronics/en",
						"https://electronics.local:9002/megastorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
